...
def main():
    ...
    if op == 1:
        ...
        if password == "":
            ...
            decrypted = decrypted.decode()[len(headerText) :]
...
if __name__ == "__main__":
    ...
    print()
    cprint(
        figlet_format("IMAGE CRYPTOGRAPHY!", font="digital"), "yellow", attrs=["bold"]
    )
    # print_credits()
    print()

    print(
        "[bold]LAKSHIT SOMANI[/bold]\n[bold]https://www.linkedin.com/in/lakshit-somani\n[/bold]"
    )

    print(
        "[bold]IMAGE CRYPTOGRAPHY[/bold] consists of Image Steganography and AES-256 encryption which allows\nyou to hide texts inside an image and you can also protect these texts with a password."
    )
    print()
